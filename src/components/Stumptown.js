...
class Stumptown extends Component {
  state = {
    ...
    description2: 'this site was chosen b/c I noticed when surfing through their various products, that the page layout was the same with the images, text and colors changing.  I created a giant array of product objects and used that to fill in the product template with the pertinent product information.  The page itself has some cool features, like the randomly generated graphics on the non-coffee items, and the "stick scroll" of the middle and right columns',
