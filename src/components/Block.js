...
class Block extends Component {
  state = {
    ...
    description2: "Slideshows are a pretty common feature and so knowing how to build one was on my list of things to do",
    description3: "To take the slideshow one step further, I had to learn how to bring up a modal type window with the correct image selected by the end user.  In addition to having the images slide from one to the other, I had to incorporate a multiple zoom in/out function",
    tech1: "HTML",
    tech2: "CSS",
    tech3: "JavaScript",
