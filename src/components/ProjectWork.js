      ...
      <section className={`project-section project-${props.project.cssClass}-noshow`}>
        <div className="project-section-wrapper">
          ...
          <div className="project-img-description-container">
            ...
            <p className="project-img-description">{props.project.description1} <a className={`project-page-link hover ${props.project.cssClass}-project-page-link`} href={props.project.gitPage} target="_blank" rel="noopener noreferrer">ViewPage</a></p>
          </div>
        </div>
      </section>
      <section className={`project-section project-${props.project.cssClass}-noshow`}>
        <div className="project-section-wrapper">
          ...
          <div className="project-img-description-container">
            ...
            <p className="project-img-description">{props.project.description2} <a className={`project-page-link hover ${props.project.cssClass}-project-page-link`} href={props.project.page2} target="_blank" rel="noopener noreferrer">ViewPage</a></p>
          </div>
        </div>
      </section>
      <section className={`project-section project-last-section`}>
        <div className="project-section-wrapper">
          ...
          <div className="project-img-description-container">
            ...
            <p className="project-img-description">{props.project.description3} <a className={`project-page-link hover ${props.project.cssClass}-project-page-link`} href={props.project.page3} target="_blank" rel="noopener noreferrer">ViewPage</a></p>
          </div>
        </div>
      </section>
    </div>
