      ...
      <section className={`project-section project-${props.project.cssClass}-noshow`}>
        <div className="project-section-wrapper">
          ...
          <div className="project-img-description-container">
            ...
            <p className="project-img-description">{props.project.description1}</p>
          </div>
        </div>
      </section>
      <section className={`project-section project-${props.project.cssClass}-noshow`}>
        <div className="project-section-wrapper">
          ...
          <div className="project-img-description-container">
            ...
            <p className="project-img-description">{props.project.description2}</p>
          </div>
        </div>
      </section>
      <section className={`project-section project-last-section`}>
        <div className="project-section-wrapper">
          ...
          <div className="project-img-description-container">
            ...
            <p className="project-img-description">{props.project.description3}</p>
          </div>
        </div>
      </section>
    </div>
